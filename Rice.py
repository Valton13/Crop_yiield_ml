# rice_yield_forecast.py
# Predict Rice Yield (kg/ha) for 2019–2021 for Each District in Punjab
...
print("🌾 Rice Yield Prediction for 2019–2021 (Punjab, India)")

# --- Step 1: Load Data ---
df = pd.read_csv('Table_4.7_Yield_Rice_1.csv')
...
pred_df.to_csv('Rice_Yield_Predictions_2019_2021.csv')

print(f"\n📊 Predictions saved to 'Rice_Yield_Predictions_2019_2021.csv'")
...
if sample_district in pred_df.columns:
    ...
    plt.title(f"Rice Yield Trend & Forecast: {sample_district}")
    plt.xlabel("Year")
